...
#define GPIO_DS18B20_PIN  (GPIO_NUM_13)      //sensor gpio pin
...
{
        gpio_reset_pin(GPIO_NUM_13);  // Resets any previous config
        gpio_config_t io_conf = {
        .pin_bit_mask = 1ULL << GPIO_NUM_13,  // bit mask of the pin
